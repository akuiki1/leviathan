<x-admin-layout>
    ...
    <script>
    // Fungsi untuk check member sebelum approve (sama seperti di tim/index)
    async function checkMembersBeforeApprove(timId) {
        ...
        try {
            ...
            if (data.has_over_limit) {
                ...
                alertMessage = 'Tim tidak dapat disetujui karena beberapa anggota sudah melebihi batas maksimal pengambilan honor.';
            ...
            const result = await Swal.fire({
                ...
                width: 700,
                customClass: {
                    confirmButton: data.has_over_limit ? 'btn btn-secondary' : 
                                  (data.has_warning ? 'btn btn-warning' : 'btn btn-success'),
    ...
    /* Progress bar styles for member status */
    .progress {
